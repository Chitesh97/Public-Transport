...
class Producer:
    ...
    def create_topic(self):
        ...
        if self.topic_name in set(
            ...
            logger.info("Skipping existing topic {}".format(self.topic_name))
            return
        logger.info(
            "Creating topic {} with partition {} replicas {}".format(
            self.topic_name,
            self.num_partitions,
            self.num_replicas
            )
        ...
        for topic, future in futures.items():
            try:
                ...
                logger.fatal("Failed to create topic {}: {}".format(topic, e))
